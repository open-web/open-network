...
(function() {
    ...
    angular.module('BlurAdmin.pages.onlineConsultation')
        .controller('OnlineConsultationController', OnlineConsultationController)
        .controller('ModalsPageCtrl', ModalsPageCtrl);

    /** @ngInject */
    function OnlineConsultationController($scope, $filter, editableOptions, editableThemes, $uibModal, $http) {
