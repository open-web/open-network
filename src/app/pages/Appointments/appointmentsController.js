...
(function() {
    ...
    /** @ngInject */
    function AppointmentsController($scope, $filter, editableOptions, editableThemes, $uibModal, $http) {
        ...
        /*Create New Appointment START*/
        $scope.AddAppointment = function(page, size) {
        ...
        vm.addNewAppointment = addNewAppointment;
        vm.addUserDetails = {
            firstname: "",
            lastname: "",
            username: "",
        ...
        $scope.editAppointment = function(id, size) {
        ...
        /* Date Picker */
        $scope.getMedicalRecord = function(id, size) {
            ...
            $scope.modalInstanceEdit = $uibModal.open({
                animation: true,
                templateUrl: 'getMedicalRecord.html',
                size: size,
